        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">أنواع الشهادات</h3>
                        ...
                        <table class="table table-bordered table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $certificateType->created_at->format('Y-m-d') }}</td>
                                    <td>
                                        <a href="{{ route('certificate-types.show', $certificateType) }}" 
                                           class="btn btn-info btn-sm" title="عرض">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ route('certificate-types.edit', $certificateType) }}" 
                                ...
                                @empty
                                <tr>
                                    <td colspan="5" class="text-center">لا توجد أنواع شهادات</td>
                                </tr>
                                @endforelse
                            </tbody>
                        </table>
